...
import { AdminLiteRedeemCodesManager } from "@/app/admin/redeem-shared/AdminLiteRedeemCodesManager";
import { AdminRedeemFaqsManager } from "@/app/admin/redeem-shared/AdminRedeemFaqsManager";
import {
      ...
      >
        ...
        <div className="admin-pages-editor-wrap" style={{ marginBottom: 12 }}>
          <RichTextEditor
            ...
            storageKey="bgmi_admin_bgmi_lite_redeem_article_v1"
          />
        </div>
        <Field
