...
<ul>
  <li><b>Device Type:</b> (Low-end Android, Premium Android, or iPhone/iPad)</li>
  <li><b>Playing Style:</b> (Non-Gyroscope, Full Gyroscope, or Scope-Only Gyro)</li>
  <li><b>Control Layout:</b> (2-Finger, 3-Finger, or 4-Finger/Claw)</li>
</ul>
<p>
...
<p>To get the most from our calculator, it helps to understand how these settings work:</p>
...
<ul>
  ...
  <li>Optional: paste the generated BGMI Sensitivity Code in the Upload to Cloud section.</li>
</ul>
