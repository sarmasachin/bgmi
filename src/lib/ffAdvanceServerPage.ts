...
export const FF_ADVANCE_SERVER_PAGE = {
  ...
  pills: [
    ...
    { label: "Source: Official Garena" },
  ],
  /** Hero countdown — estimated OB55 Advance Server open (IST). Update when Garena announces. */
  countdown: {
  ...
  cards: [
    {
      ...
      summary:
        "Advance Server is Garena’s early test build. Selected players try new weapons, characters, and map changes before everyone else gets the OB update.",
      points: [
        "Same idea every OB cycle — test first, release later",
        "You help spot bugs and send feedback to Garena",
    ...
    },
    {
      ...
      summary:
        "Registration happens on Garena’s official site only. Log in, submit your form, then wait — selection is not guaranteed.",
      points: [
        "Open ff-advance.ff.garena.com on your phone browser",
        "Log in with the Google or Facebook account linked to your Free Fire ID",
        "Fill the registration form and submit it",
        "Wait for selection — check the Garena dashboard for your status",
    ...
    },
    {
      ...
      summary:
        "Advance Server APK is Android-only and comes from Garena. Follow these steps so the install does not fail on first open.",
      points: [
        "Use Chrome/Firefox on your Android phone — open the official Garena Advance site",
        "After selection, tap Download APK on Garena (never a third-party mirror)",
    ...
    },
    {
      ...
      summary:
        "Advance Server is free from Garena. If someone asks you to pay for a code or APK, walk away — that is a scam.",
      points: [
        "Download only from ff-advance.ff.garena.com — never third-party sites",
    ...
    },
    {
      ...
      points: [
        "Expected around the next OB window after OB54 (exact dates come from Garena)",
    ...
    },
    {
      ...
      summary:
        "Registering does not mean you get in. Garena picks a limited number of players and shows the activation code on your official dashboard.",
      points: [
        "Log in again at ff-advance.ff.garena.com with the same Google / Facebook account",
        ...
        "Copy the code, open the official Advance Server APK, and enter it to log in",
    ...
    },
    {
      ...
      summary:
        "Once Garena shows your code, you enter it inside the official Advance Server app — not on the website download page alone.",
      points: [
        "Install the official Advance Server APK from Garena’s site first",
        "Open the Advance Server app and choose Google or Facebook login",
        "When asked for an activation code, paste the code from your Garena dashboard",
    ...
    },
    {
      ...
      summary:
        "Advance Server is not always live. It opens for a short window each OB cycle — check Garena’s official site for the real status.",
      points: [
        "Visit ff-advance.ff.garena.com — this is the only official status page",
        ...
        "Ignore random “server open today” posts on social media unless Garena confirms it",
    ...
    },
    {
      ...
      points: [
        "APK won’t install — allow unknown apps for your browser, free up storage, retry from Garena only",
        "No activation code — you may not be selected yet; recheck the official dashboard later",
        "Code invalid / login failed — use the same Google/Facebook account and retype the code carefully",
        "App crashes on open — update Android WebView/Chrome, clear cache, reinstall the official APK",
        "Can’t download — Advance Server may be closed; confirm status on ff-advance.ff.garena.com",
        "iPhone users — there is no official iOS Advance Server APK; Android only",
      ],
    },
    {
      id: "pros-cons",
    ...
    },
    {
      ...
      points: [
        ...
        "Play limited-time beta events and modes Garena is still fine-tuning",
        "Report bugs and send feedback straight from the test build",
        "Earn bug-hunter style rewards when Garena runs reward programs",
        "Keep your main Free Fire / Max account safe — beta progress stays separate",
        "Android-only official APK from Garena’s Advance Server portal",
      ],
    },
  ],
  tables: [
    {
      ...
      rows: [
        ...
        ["APK source", "Official Garena Advance site", "Play Store / App Store / official store"],
    ...
    },
    {
      ...
      summary: "Exact dates change every OB — this is the usual flow Garena follows.",
      columns: ["Step", "What happens", "What you do"],
      rows: [
        ["1. Register", "Signup opens on Garena site", "Log in with Google / Facebook"],
        ["2. Selection", "Garena picks testers", "Check dashboard for your code"],
        ["3. Download APK", "Official beta APK unlocked", "Install from Garena only"],
    ...
    },
    {
      ...
      rows: [
        ...
        ["Official URL", "https://ff-advance.ff.garena.com/"],
        ["Activation code", "Required after Garena selection"],
        ["Main Free Fire ID", "Safe — beta is a separate app"],
        ["Cost", "Free — never pay for codes or APKs"],
        ["We host APK?", "No — download only from Garena"],
      ],
    },
  ],
  faqs: [
    {
      ...
      answer:
        "It is Garena’s official beta for testing upcoming OB features before the global Free Fire / Free Fire Max update. Selected players get early access on Android.",
    },
    {
      id: "as-faq-2",
      question: "Is Advance Server free?",
      answer:
        "Yes. Registration and the official APK are free from Garena. Never pay anyone for an activation code or APK file.",
    },
    {
      id: "as-faq-3",
      question: "Where do I download the Advance Server APK?",
      answer:
        "Only from https://ff-advance.ff.garena.com/ after you are selected. Do not use Telegram, random websites, or “mod APK” links.",
    },
    {
      id: "as-faq-4",
      question: "How do I get an activation code?",
      answer:
        "Register on the official Garena Advance site with your Free Fire Google or Facebook account. If Garena selects you, the code appears on your dashboard there.",
    },
    {
      id: "as-faq-5",
      question: "Does Advance Server work on iPhone?",
      answer:
        "No. The official Advance Server APK is Android only. There is no official iOS Advance Server download.",
    },
    {
      id: "as-faq-6",
      question: "Will my main Free Fire account get banned or wiped?",
      answer:
        "Advance Server is a separate beta app. Your main Free Fire / Max rank and inventory stay on the live game. Still download only from Garena.",
    },
    {
      id: "as-faq-7",
      question: "Why didn’t I get selected?",
      answer:
        "Garena only picks a limited number of testers each cycle. Registering does not guarantee a code. Try again when the next Advance Server registration opens.",
    },
    {
      id: "as-faq-8",
